export const faq = [
  {
    ...
    answer:
      "Wash & fold is priced by the pound with a simple per-order minimum. We confirm the exact total when we message you back to confirm your booking — no surprise fees.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "We'll confirm payment details when we reach out to confirm your booking — cash, card, and digital payment are all available.",
  },
  {
