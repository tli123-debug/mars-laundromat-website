export const about = {
  hero: {
    eyebrow: "About Us",
    headline: "Family-owned. Rooted in Park Slope.",
    subheadline:
      "We were built on the people who walked through the door. Over the years, we've watched neighbors become regulars, regulars become friends, and friends move on to new chapters, leaving behind a block that's a little quieter without them.",
  },
  ...
  values: [
    {
      ...
      description: "A real person reviews and confirms every booking, we don't let software make promises we can't keep.",
    },
    {
      title: "Consistency you can count on",
      description: "The same care and attention, whether it's your first order or your five-hundredth.",
    },
    {
      title: "Proud to be local",
      description: "Family-owned, with roots in this neighborhood that go back 15 years.",
    },
  ],
} as const;
